...
local function set_theme(colors)
	local theme = {}
	...
	theme.clickable_active_bg = theme.colors[2]
	...
	-- Sliders
	theme.slider_handle_color = theme.colors[4]
	theme.slider_bar_active_color = theme.colors[3]
	...
	theme.search_app_selected_color = theme.colors[11]
	theme.search_prompt_fg_color = theme.fg0
	theme.search_prompt_cursor_color = theme.colors[3]

	-- Taglist
	theme.taglist_bg_focus = theme.fg0
	theme.taglist_bg_occupied = theme.colors[10]
	theme.taglist_bg_empty = theme.bg0

	theme.taglist_spacing = dpi(2)
	theme.taglist_active_fg = theme.fg0
	theme.taglist_occupied_fg = theme.colors[10]
	...
	theme.titlebar_close_button_normal =
		gears.color.recolor_image(themes_path .. "titlebar/close_normal.png", theme.bg0)
	theme.titlebar_close_button_focus =
		gears.color.recolor_image(themes_path .. "titlebar/close_focus.png", theme.colors[2])
	theme.titlebar_minimize_button_normal =
		gears.color.recolor_image(themes_path .. "titlebar/minimize_normal.png", theme.bg0)
	theme.titlebar_minimize_button_focus =
		gears.color.recolor_image(themes_path .. "titlebar/minimize_focus.png", theme.colors[4])
	theme.titlebar_maximized_button_normal_inactive =
		gears.color.recolor_image(themes_path .. "titlebar/maximized_normal_inactive.png", theme.bg0)
	theme.titlebar_maximized_button_focus_inactive =
		gears.color.recolor_image(themes_path .. "titlebar/maximized_focus_inactive.png", theme.colors[3])
	theme.titlebar_maximized_button_normal_active =
		gears.color.recolor_image(themes_path .. "titlebar/maximized_normal_active.png", theme.bg0)
	theme.titlebar_maximized_button_focus_active =
		gears.color.recolor_image(themes_path .. "titlebar/maximized_focus_active.png", theme.colors[3])
	...
	rnotification.connect_signal("request::rules", function()
		rnotification.append_rule({
			...
			properties = { bg = theme.colors[2], fg = theme.bg0 },
		})
	end)
