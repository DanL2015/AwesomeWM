...
local theme_bg = wibox.widget({
	image = gears.surface.load_uncached("/home/daniel/Pictures/Backgrounds/Raven.png"),
	valign = "center",
	halign = "center",
	downscale = true,
...
-- naughty.notification({text="current theme: "..beautiful.backgrounds})
...
widget:add_widget_at(left_buttons_widget, 1, 1, 6, 3)
widget:add_widget_at(screenshot_full_widget, 1, 4, 2, 1)
widget:add_widget_at(screenshot_select_widget, 1, 5, 2, 1)
widget:add_widget_at(power_widget, 1, 6, 2, 1)
widget:add_widget_at(weather, 3, 4, 4, 3)
widget:add_widget_at(brightness, 7, 1, 3, 6)
widget:add_widget_at(volume, 10, 1, 3, 6)
widget:add_widget_at(media, 13, 1, 3, 6)
widget:add_widget_at(theme, 16, 1, 7, 6)
